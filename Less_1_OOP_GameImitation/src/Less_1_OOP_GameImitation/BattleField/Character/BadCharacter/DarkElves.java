...
public class DarkElves extends SuperBadBoy{

    public DarkElves(String name, WeaponForBadBoy weapon, int experience) {
    ...
    public void killable() {
        System.out.println(getName() + " с любым оружием смертоносен, тем более с " +
